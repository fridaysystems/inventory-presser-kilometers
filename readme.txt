...
Add-on for Inventory Presser. Changes odometer units from miles to kilometers. Does not change the odometer value.

== Description ==

An add-on for the Inventory Presser dealership plugin that changes odometer units to kilometers.
